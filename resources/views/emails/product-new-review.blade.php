...
<head>
  <meta charset="UTF-8">
  <title>Nueva reseña en tu producto | TukiShop</title>
          ...
          <tr>
            <td style="padding:32px 28px;">
              <h1 style="margin:0 0 12px;font-size:22px;line-height:1.3;color:#111827;">
                ¡Tu producto ha recibido una nueva calificación!
              </h1>

              <p style="margin:0 0 20px;font-size:15px;line-height:1.6;color:#111827;">
                <strong>{{ $reviewer_name }}</strong> ha dejado una reseña sobre tu producto
                <strong>{{ $product_name }}</strong> de tu tienda <strong>{{ $store_name }}</strong>.
              </p>
              ...
              <!-- Imagen del producto -->
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                style="background:#ffffff;border-radius:10px;margin-bottom:24px;border:1px solid #e5e7eb;">
                <tr>
                  <td align="center" style="padding:16px;">
                    <img src="{{ $product_image }}" alt="{{ $product_name }}"
                         width="160" height="160"
                         style="border-radius:8px;object-fit:cover;">
                    <p style="margin:12px 0 0;font-size:15px;font-weight:bold;color:#111827;">
                      {{ $product_name }}
                    </p>
                  </td>
                </tr>
              ...
              <p style="margin:0 0 24px;text-align:center;">
                <a href="{{ $product_dashboard_url }}"
                  ...
                  Ver reseña del producto
                </a>
              </p>

              <p style="margin:0 0 12px;font-size:13px;line-height:1.6;color:#000000;">
                Ingresa a tu panel de vendedor para responder o revisar todas las calificaciones de tus productos.
              </p>
              ...
              <p style="margin:0;font-size:12px;line-height:1.6;color:#000000;">
                ...
                <a href="{{ $product_dashboard_url }}" style="color:#0ea5e9;word-break:break-all;">{{ $product_dashboard_url }}</a>
              </p>
            </td>
          </tr>
