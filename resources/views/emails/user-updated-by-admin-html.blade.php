...
<head>
  <meta charset="UTF-8">
  <title>Actualización de perfil | TukiShop</title>
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0"
          ...
          <tr>
            <td align="center" style="padding:24px;background:linear-gradient(135deg,#FFD027,#FF6F3B,#5B2A86);">
              <img src="https://res.cloudinary.com/dpbghs8ep/image/upload/v1760314036/Tuki_vitzem.png" alt="TukiShop" width="55" style="display:block;">
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:32px 28px;">
              ...
              <p style="margin:0 0 16px;font-size:15px;color:#111827;">
                Si tú solicitaste esta modificación, no necesitas hacer nada más. Si no reconoces esta acción, contáctanos de inmediato para revisar tu cuenta.
              </p>

              <p style="text-align:center;margin:20px 0;">
                <a href="{{ $dashboard_url }}" style="background:linear-gradient(135deg,#FFD027,#FF6F3B);color:#ffffff;text-decoration:none;padding:12px 24px;border-radius:8px;display:inline-block;font-weight:bold;">
                  Ver mi cuenta
                </a>
              </p>
